...
import {Category, getCategories, createProduct, getCategoryById, Product} from '../services/api';
...
const AddProductForm: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const cat = await getCategoryById(+formData.categoryId);
            const {name} = cat.data;
            const product: Product = {
                ...
                category: {id: parseInt(formData.categoryId), name: name},
